...
public class QS extends Fragment {
    ...
    private void setupQQS() {
        CardView qqs = view.findViewById(R.id.sysui_qqs_count_card);
        if (activity.setThings.SDK_INT < 24) qqs.setVisibility(View.GONE);
        else {
            final TextView count = view.findViewById(R.id.sysui_qqs_count_text);
            SeekBar slider = view.findViewById(R.id.sysui_qqs_count);
    ...
    private void setupSwitches() {
        Switch fancy_anim = view.findViewById(R.id.allow_fancy_animation);
        Switch move_whole_rows = view.findViewById(R.id.move_full_rows);
