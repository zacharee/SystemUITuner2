...
package com.zacharee1.systemuituner.iaps;
...
public class IabHelper {
    ...
    @SuppressWarnings("WeakerAccess")
    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
                                               OnIabPurchaseFinishedListener listener, @SuppressWarnings("SameParameterValue") String extraData)
        throws IabAsyncInProgressException {
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public void launchPurchaseFlow(Activity act, String sku, String itemType, @SuppressWarnings("SameParameterValue") List<String> oldSkus,
        ...
        try {
            ...
            act.startIntentSenderForResult(pendingIntent != null ? pendingIntent.getIntentSender() : null,
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public void queryInventoryAsync(@SuppressWarnings("SameParameterValue") final boolean querySkuDetails, @SuppressWarnings("SameParameterValue") final List<String> moreItemSkus,
                                    @SuppressWarnings("SameParameterValue") final List<String> moreSubsSkus, final QueryInventoryFinishedListener listener)
        throws IabAsyncInProgressException {
     ...
     */
    public void consumeAsync(Purchase purchase, @SuppressWarnings("SameParameterValue") OnConsumeFinishedListener listener)
        throws IabAsyncInProgressException {
        checkNotDisposed();
        checkSetupDone("consume");
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            for (int i = 0; i < (purchaseDataList != null ? purchaseDataList.size() : 0); ++i) {
                String purchaseData = purchaseDataList.get(i);
                String signature = signatureList != null ? signatureList.get(i) : null;
